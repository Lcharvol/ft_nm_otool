...
/*   Updated: 2018/10/19 14:46:54 by lcharvol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						print_text_section_32(struct section
		*sects, char *ptr, t_env *env);
void						print_text_section_64(struct section_64
		*sects, char *ptr, t_env *env);
...
int							is_corrupted_64(struct segment_command_64
		*sc, t_env *env);
int							is_corrupted(struct segment_command	*sc,
		t_env *env);
