...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/19 21:48:26 by lcharvol          #+#    #+#             */
/*   Updated: 2018/09/19 21:51:21 by lcharvol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/nm.h"

static void			print_text_section_content_64(uint64_t offset, char *ptr,
...
static void			print_text_section_content_32(uint32_t offset, char *ptr,
...
void				print_text_section_32(struct section *sects,
		char *ptr, t_env *env)
{
	uint32_t i;
